...
const FeaturedTutorCard = ({ navigate, sectionTitle, sectionDescription, tutorName, tutorSubject, tutorBio, imageUrl }) => {
  return (
      ...
      <div>
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <img 
            ...
            onError={(e) => e.target.src = 'https://placehold.co/500x400/cccccc/ffffff?text=Image'}
          />
          <div className="p-6">
            ...
            <p className="text-sm text-gray-700 mt-1">
              <span className="font-semibold">Bio :</span> {tutorBio}
            </p>
          </div>
        </div>
      </div>
...
const FeaturedTutorsSection = ({ navigate }) => {
  const tutors = [
    { 
      ...
      tutorBio: 'Learn Everything about Calculus 1',
